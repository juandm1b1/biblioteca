...
SECRET_KEY = '82^-ud!&fszp)_&g7o0%jpi%bim#!m6y2af_d7f4opyatc0l+r'
...
# --Esto se necesitaba con from django.contrib.auth.views import login, logout_then_login -YA NO EXISTE- #
# LOGIN_REDIRECT_URL = reverse_lazy('index')  # Para indicar a donde se va a redirecccionar una vez se inicie sesión
